...
```js
<script src="https://cdn.jsdelivr.net/gh/francescomugnai/just-good-cookies@0.9.3.3/dist/justgoodcookies.min.js"></script>
```
...
However, if you want to use Tailwind with a custom prefix, you will need to create your own CSS using the Tailwind CLI tool or you can embed the new CDN: `<script src="https://cdn.tailwindcss.com"></script>`. <br/>
