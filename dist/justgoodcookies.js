    ...
    _createClass(JustGoodCookies, [{
      ...
      */
      ...
      value: function managePreferences() {
        ...
        if (!panelExists) {
          var _this$panel, _this$customStyle4, _this$panel2, _this$customStyle5, _this$customStyle6, _this$text, _this$customStyle7, _this$text2, _this$customStyle8, _this$text3;

          var cookiePanel = document.createElement("div");
          cookiePanel.innerHTML = "\n      <div id=\"preferenceDiv\" style=\"background-color: rgba(0,0,0,0.6);z-index:9999 !important;\" class=\"".concat(this.checkTailwindPrefix('w-full min-h-screen top-0 fixed flex flex-col p-6 shadow-2xl items-center justify-center mx-auto transition duration-700 ease-in-out'), " ").concat(this.panelHeader ? '' : null, " \">\n            ").concat(this.panelHeader ? "<div id=\"jgc-custom-header\" class=\"".concat(this.checkTailwindPrefix('w-full'), "\"></div>") : '', "\n              <div class=\"").concat((_this$panel = this.panel) !== null && _this$panel !== void 0 && _this$panel.bgColor ? this.panel.bgColor : "".concat((_this$customStyle4 = this.customStyle) !== null && _this$customStyle4 !== void 0 && _this$customStyle4.preferenceDiv ? this.customStyle.preferenceDiv : this.checkTailwindPrefix('bg-white dark:bg-gray-800 max-w-3xl w-full')), " ").concat(((_this$panel2 = this.panel) === null || _this$panel2 === void 0 ? void 0 : _this$panel2.padding) == false ? '' : "".concat(this.checkTailwindPrefix('p-2')), "\">\n                <div class=\"").concat((_this$customStyle5 = this.customStyle) !== null && _this$customStyle5 !== void 0 && _this$customStyle5.panelHeader ? this.customStyle.panelHeader : "".concat(this.checkTailwindPrefix('md:flex justify-between px-4 py-4')), "\">\n                  <h2 class=\"").concat((_this$customStyle6 = this.customStyle) !== null && _this$customStyle6 !== void 0 && _this$customStyle6.panelTitle ? this.customStyle.panelTitle : this.checkTailwindPrefix('dark:text-gray-300 leading-snug text-xl font-bold m-0 p-0'), "\">\n                    ").concat((_this$text = this.text) !== null && _this$text !== void 0 && _this$text.panelTitle ? this.text.panelTitle : '', " \n                  </h2>\n                  <div class=\"").concat(this.checkTailwindPrefix('space-x-1 md:mt-0 mt-4'), "\">\n                    <button role=\"button\" id=\"closePreferencePanel\" type=\"button\" class=\"").concat((_this$customStyle7 = this.customStyle) !== null && _this$customStyle7 !== void 0 && _this$customStyle7.saveButton ? this.customStyle.saveButton : "".concat(this.checkTailwindPrefix('px-3 py-1 uppercase font-bold tracking-wide text-xs z-index-10 relative rounded-md  focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer text-green-600 ring-1 ring-green-600')), " \">\n                      ").concat((_this$text2 = this.text) !== null && _this$text2 !== void 0 && _this$text2.saveButton ? this.text.saveButton : this.locale.saveAndContinue, "  \n                    </button>\n                    <button role=\"button\" id=\"closePreferencePanelAcceptAll\" type=\"button\" class=\"").concat((_this$customStyle8 = this.customStyle) !== null && _this$customStyle8 !== void 0 && _this$customStyle8.saveAllButton ? this.customStyle.saveAllButton : "".concat(this.checkTailwindPrefix('px-3 py-1 uppercase font-bold tracking-wide text-xs z-index-10 relative rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 cursor-pointer text-green-600 ring-1 ring-green-600')), "  \">\n                      ").concat((_this$text3 = this.text) !== null && _this$text3 !== void 0 && _this$text3.saveAllButton ? this.text.saveAllButton : this.locale.saveAndContinueAcceptAll, "  \n                    </button>\n                  </div>\n                </div>\n                <div>\n                  <div style=\"overflow-y: scroll; -webkit-overflow-scrolling: touch; max-height: calc(100vh - 400px);\" class=\"").concat(this.panel && this.panel.stripes ? "".concat(this.panel.stripes.odd, " ").concat(this.panel.stripes.even) : this.checkTailwindPrefix('space-y-4 overflow-y-auto'), " ").concat(this.checkTailwindPrefix('text-sm py-4'), "\"> \n                    ").concat(this.generateOptions(), "\n                  </div> \n                </div>\n              </div>\n              ").concat(this.panelFooter ? "<div id=\"jgc-custom-footer\" class=\"".concat(this.checkTailwindPrefix('w-full'), "\"></div>") : '', "\n            </div>\n      </div>\n      ");
      ...
      */
      ...
      value: function managePreferencesLink(colors) {
        var _this$customStyle9, _this$customStyle10, _this$text$preference;

        var createButton = document.createElement("div");
        return createButton.innerHTML = "\n    <button id=\"openPanel\" style=".concat((_this$customStyle9 = this.customStyle) !== null && _this$customStyle9 !== void 0 && _this$customStyle9.preferencesText ? '' : 'font-size:0.6rem', " ;\" class=\"").concat(colors ? colors : "".concat((_this$customStyle10 = this.customStyle) !== null && _this$customStyle10 !== void 0 && _this$customStyle10.preferencesText ? this.customStyle.preferencesText : this.checkTailwindPrefix('font-bold uppercase dark:text-white')), "\">\n      ").concat((_this$text$preference = this.text.preferencesText) !== null && _this$text$preference !== void 0 ? _this$text$preference : 'Manage and choose cookies', " \n    </button>");
      }
      /**
      * Open panel
      */
      ...
      */
      ...
      value: function animateToggle(val, buttonType) {
        ...
        var bgColor = (_this$customStyle11 = this.customStyle) !== null && _this$customStyle11 !== void 0 && _this$customStyle11.toggles ? this.customStyle.toggles : this.checkTailwindPrefix('bg-green-200');
      ...
      value: function init(data) {
        ...
        if (data.style) {
          ...
          this.customStyle = {
            ...
            closeButton: (_data$style4 = data.style) !== null && _data$style4 !== void 0 && _data$style4.closeButton ? this.isString(data.style.closeButton, "closeButton") : null,
            ...
            panelTitle: (_data$style9 = data.style) !== null && _data$style9 !== void 0 && _data$style9.panelTitle ? this.isString(data.style.panelTitle, "panelTitle") : null,
            preferenceDiv: (_data$style10 = data.style) !== null && _data$style10 !== void 0 && _data$style10.preferenceDiv ? this.isString(data.style.preferenceDiv, "preferenceDiv") : null,
            preferencesText: (_data$style11 = data.style) !== null && _data$style11 !== void 0 && _data$style11.preferencesText ? this.isString(data.style.preferencesText, "preferencesText") : null,
            privacyLink: (_data$style12 = data.style) !== null && _data$style12 !== void 0 && _data$style12.privacyLink ? this.isString(data.style.privacyLink, "privacyLink") : null,
            reject: (_data$style13 = data.style) !== null && _data$style13 !== void 0 && _data$style13.reject ? this.isString(data.style.reject, "reject") : null,
            saveButton: (_data$style14 = data.style) !== null && _data$style14 !== void 0 && _data$style14.saveButton ? this.isString(data.style.saveButton, "classes") : null,
            saveAllButton: (_data$style15 = data.style) !== null && _data$style15 !== void 0 && _data$style15.saveAllButton ? this.isString(data.style.saveAllButton, "classes") : null,
            servicesText: (_data$style16 = data.style) !== null && _data$style16 !== void 0 && _data$style16.servicesText ? this.isString(data.style.servicesText, "servicesText") : null,
            servicesTag: (_data$style17 = data.style) !== null && _data$style17 !== void 0 && _data$style17.servicesTag ? this.isString(data.style.servicesTag, "servicesTag") : null,
            stripes: (_data$style18 = data.style) !== null && _data$style18 !== void 0 && _data$style18.stripes ? this.isString(data.style.stripes, "stripes: classes") : null
          };
        } // Cookie Categories
        ...
        this.style = {
          yesCookies: "".concat((_this$customStyle52 = this.customStyle) !== null && _this$customStyle52 !== void 0 && _this$customStyle52.accept ? this.customStyle.accept : "".concat(this.checkTailwindPrefix('text-green-800 dark:text-green-300 bg-green-50 hover:bg-green-100 transition-all duration-300 dark:bg-green-900 ring-1 ring-green-200 px-2 py-0.5 text-xs uppercase font-bold items-center rounded my-2 border-none'))),
          noCookies: "".concat((_this$customStyle53 = this.customStyle) !== null && _this$customStyle53 !== void 0 && _this$customStyle53.reject ? this.customStyle.reject : "".concat(this.checkTailwindPrefix('text-red-800 dark:text-red-300 bg-red-50 hover:bg-red-100 transition-all duration-300 dark:bg-red-900 ring-red-200 ring-1 px-2 py-0.5 text-xs uppercase font-bold items-center rounded my-2 border-none'))),
          yesCookies2: "".concat((_this$customStyle54 = this.customStyle) !== null && _this$customStyle54 !== void 0 && _this$customStyle54.accept ? this.customStyle.accept : "".concat(this.checkTailwindPrefix('text-green-600 bg-transparent ring-green-400 ring-2 px-3 leading-6 text-xs text-center font-medium uppercase transition transition-all duration-300  hover:bg-green-100 focus:shadow-2xl rounded-full border-none'))),
          noCookies2: "".concat((_this$customStyle55 = this.customStyle) !== null && _this$customStyle55 !== void 0 && _this$customStyle55.reject ? this.customStyle.reject : "".concat(this.checkTailwindPrefix('text-red-600 bg-transparent ring-red-600 ring-2 px-3 leading-6 text-xs text-center font-medium uppercase transition transition-all duration-300  hover:bg-red-100 focus:shadow-2xl rounded-full border-none'))),
          yesCookies3: "".concat((_this$customStyle56 = this.customStyle) !== null && _this$customStyle56 !== void 0 && _this$customStyle56.accept ? this.customStyle.accept : "".concat(this.checkTailwindPrefix('text-green-600 bg-transparent transition transition-all duration-300 ring-green-400 ring-2 px-3 py-2 leading-tight text-xs text-center font-medium uppercase transition hover:bg-green-100 focus:shadow-2xl rounded-full border-none'))),
          noCookies3: "".concat((_this$customStyle57 = this.customStyle) !== null && _this$customStyle57 !== void 0 && _this$customStyle57.reject ? this.customStyle.reject : "".concat(this.checkTailwindPrefix('text-red-600 bg-transparent transition transition-all duration-300 ring-red-600 ring-2 px-3 py-2 leading-tight text-xs text-center font-medium uppercase transition hover:bg-red-100 focus:shadow-2xl rounded-full border-none'))),
          yesCookies4: "".concat((_this$customStyle58 = this.customStyle) !== null && _this$customStyle58 !== void 0 && _this$customStyle58.accept ? this.customStyle.accept : "".concat(this.checkTailwindPrefix('text-gray-500 dark:text-green-300 px-3 leading-6 text-xs text-center font-bold uppercase transition focus:shadow-2xl tracking-widest rounded-full border-none'))),
          noCookies4: "".concat((_this$customStyle59 = this.customStyle) !== null && _this$customStyle59 !== void 0 && _this$customStyle59.reject ? this.customStyle.reject : "".concat(this.checkTailwindPrefix('text-gray-500  dark:text-red-300 px-3 leading-6 text-xs text-center font-bold uppercase transition focus:shadow-2xl tracking-widest rounded-full border-none'))),
          yesCookies5: "".concat((_this$customStyle60 = this.customStyle) !== null && _this$customStyle60 !== void 0 && _this$customStyle60.accept ? this.customStyle.accept : "".concat(this.checkTailwindPrefix('text-white dark:text-green-400 px-5 text-sm text-center font-bold uppercase transition focus:shadow-2xl tracking-wide rounded-full border-none'))),
          noCookies5: "".concat((_this$customStyle61 = this.customStyle) !== null && _this$customStyle61 !== void 0 && _this$customStyle61.reject ? this.customStyle.reject : "".concat(this.checkTailwindPrefix('text-red-600 dark:text-red-400 px-5 leading-6 text-sm text-center font-bold uppercase transition focus:shadow-2xl tracking-wide rounded-full border-none'))),
          yesCookies6: "".concat((_this$customStyle62 = this.customStyle) !== null && _this$customStyle62 !== void 0 && _this$customStyle62.accept ? this.customStyle.accept : "".concat(this.checkTailwindPrefix('text-white dark:text-gray-400 px-12 py-2 text-sm text-center font-semibold uppercase transition focus:shadow-2xl tracking-widest rounded-full border-none'))),
          yesCookies7: "".concat((_this$customStyle63 = this.customStyle) !== null && _this$customStyle63 !== void 0 && _this$customStyle63.reject ? this.customStyle.reject : "".concat(this.checkTailwindPrefix('text-gray-600 dark:text-white rounded-full text-xs font-semibold focus:shadow-2xl border-none'))),
          noCookies7: "".concat((_this$customStyle64 = this.customStyle) !== null && _this$customStyle64 !== void 0 && _this$customStyle64.accept ? this.customStyle.accept : "".concat(this.checkTailwindPrefix('text-gray-600 dark:text-white text-xs leading-6 font-bold focus:shadow-2xl rounded-full border-none'))),
          yesCookies8: "".concat((_this$customStyle65 = this.customStyle) !== null && _this$customStyle65 !== void 0 && _this$customStyle65.reject ? this.customStyle.reject : "".concat(this.checkTailwindPrefix('text-gray-600 group-hover:text-green-600 dark:bg-green-900 py-2 dark:text-green-400 px-5 text-sm text-center font-semibold transition focus:shadow-2xl tracking-wide rounded-full border-none'))),
          selectedCookies8: "".concat((_this$customStyle66 = this.customStyle) !== null && _this$customStyle66 !== void 0 && _this$customStyle66.accept ? this.customStyle.accept : "".concat(this.checkTailwindPrefix('text-orange-600 group-hover:text-orange-600 dark:text-orange-400 dark:bg-orange-900 py-2 px-5 text-sm text-center font-semibold transition focus:shadow-2xl tracking-wide rounded-full border-none'))),
          noCookies8: "".concat((_this$customStyle67 = this.customStyle) !== null && _this$customStyle67 !== void 0 && _this$customStyle67.accept ? this.customStyle.accept : "".concat(this.checkTailwindPrefix('text-red-600 group-hover:text-red-600 dark:bg-red-900 py-2 dark:text-red-400 px-5 leading-6 text-sm text-center font-semibold transition focus:shadow-2xl tracking-wide rounded-full border-none'))),
          yesCookies9: "".concat((_this$customStyle68 = this.customStyle) !== null && _this$customStyle68 !== void 0 && _this$customStyle68.reject ? this.customStyle.reject : "".concat(this.checkTailwindPrefix('text-white bg-black dark:text-gray-100 px-6 py-1 text-xs text-center font-semibold uppercase transition focus:shadow-2xl tracking-widest rounded-full border-none'))),
          noCookies9: "".concat((_this$customStyle69 = this.customStyle) !== null && _this$customStyle69 !== void 0 && _this$customStyle69.accept ? this.customStyle.accept : "".concat(this.checkTailwindPrefix('text-red-900 ring-1 ring-red-900 dark:text-red-700 dark:ring-red-700 px-6 py-1 text-xs text-center font-semibold uppercase transition focus:shadow-2xl tracking-widest rounded-full border-none')))
